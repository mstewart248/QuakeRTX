...
extern cvar_t d3d9_lightmaps;
extern cvar_t d3d9_lightscale;
...
extern cvar_t d3d9_pvsexpand;
extern cvar_t d3d9_lightlimit;
extern cvar_t d3d9_lightcycle;
extern cvar_t d3d9_lightgroup;
extern cvar_t d3d9_worldbatch;
...
void R_Init (void)
{
	...
	Cvar_RegisterVariable (&d3d9_lightmaps);
	Cvar_RegisterVariable (&d3d9_lightscale);
	Cvar_RegisterVariable (&d3d9_viewmodel_dist);
	Cvar_RegisterVariable (&d3d9_gpuskinning);
	Cvar_RegisterVariable (&d3d9_lerpmodels);
	Cvar_RegisterVariable (&d3d9_modelnormals);
	Cvar_RegisterVariable (&d3d9_skytextured);
	Cvar_RegisterVariable (&d3d9_nocull);
	Cvar_RegisterVariable (&d3d9_pvsexpand);
	Cvar_RegisterVariable (&d3d9_lightlimit);
	Cvar_RegisterVariable (&d3d9_lightcycle);
	Cvar_RegisterVariable (&d3d9_lightgroup);
	Cvar_RegisterVariable (&d3d9_worldbatch);
	//spike
...
// FIXME: is this one short?
	...
	//the expanded PVS is cached against a leaf pointer, and the leaves have
	//just been reallocated under it
	R_PVSExpandNewMap ();
