...
//how much of the level to submit this frame, from d3d9_nocull. 0 = Quake's
//own culling, 1 = no frustum cull, 2 = no backface cull either.
extern int r_nocull;
qboolean R_CullBox (vec3_t emins, vec3_t emaxs);

//drops the cached expanded PVS, which is keyed on a leaf pointer
void R_PVSExpandNewMap (void);

//the static world, triangulated into per-texture index runs at map load
